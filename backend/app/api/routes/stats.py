...
def get_stats_overview_route(
    ...
    return get_overview(db, tz_offset_minutes=tz_offset_minutes)
...
def get_stats_trend_route(
    ...
    return get_trend(db, days=days, bucket=bucket, tz_offset_minutes=tz_offset_minutes)
...
def get_stats_heatmap_route(
    ...
    return get_heatmap(db, days=days, tz_offset_minutes=tz_offset_minutes)
...
def get_stats_top_weak_route(
    ...
    return get_top_weak(db, limit=limit, days=days)
...
def get_stats_tag_radar_route(
    ...
    return get_tag_radar(db, min_count=min_count)
